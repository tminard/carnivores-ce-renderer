...
C2Sky::C2Sky(std::ifstream& instream)
{
  ...
  this->m_shader = std::unique_ptr<ShaderProgram>(new ShaderProgram("resources/shaders/sky.vs", "resources/shaders/sky.fs"));
  this->m_cloud_shader = std::unique_ptr<ShaderProgram>(new ShaderProgram("resources/shaders/sky_clouds.vs", "resources/shaders/sky_clouds.fs"));
