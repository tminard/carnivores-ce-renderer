/*
    ...
    OpenGL loader generated by glad 0.1.36 on Sun Aug  4 21:58:46 2024.
    ...
    Commandline:
        --profile="core" --api="gl=4.1" --generator="c" --spec="gl" --local-files --extensions="GL_ARB_multitexture,GL_EXT_texture_array"
    Online:
        https://glad.dav1d.de/#profile=core&language=c&specification=gl&loader=on&api=gl%3D4.1&extensions=GL_ARB_multitexture&extensions=GL_EXT_texture_array
*/
