...
int main(int argc, const char * argv[])
{
  ...
  std::unique_ptr<C2MapRscFile> cMapRsc(new C2MapRscFile(CEMapType::C1, "C:/src/cce/game/c1/area3.rsc"));
  std::shared_ptr<C2MapFile> cMap(new C2MapFile(CEMapType::C1, "C:/src/cce/game/c1/area3.map", cMapRsc.get()));
